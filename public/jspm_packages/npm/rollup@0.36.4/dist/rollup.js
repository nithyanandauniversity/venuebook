...
(function(Buffer, process) {
  ...
  pp.checkDefaultValueErrors = function(refDestructuringErrors, isArrow, andThrow) {
    ...
    if (!andThrow)
      return !!(yieldPos || awaitPos);
    if (yieldPos && (!awaitPos || yieldPos < awaitPos))
      this.raise(yieldPos, "Yield expression cannot be a default value");
    if (awaitPos)
      this.raise(awaitPos, "Await expression cannot be a default value");
  };
  ...
  pp$2.parseRest = function(allowNonIdent, refDestructuringErrors) {
    ...
    if (allowNonIdent)
      ...
      node.argument = this.type === tt.name || this.type === tt.bracketL ? this.parseBindingAtom(refDestructuringErrors) : this.unexpected();
  ...
  pp$3.parseMaybeAssign = function(noIn, refDestructuringErrors, afterLeftParse) {
    if (this.inGenerator && this.isContextual("yield"))
      return this.parseYield(refDestructuringErrors);
  ...
  pp$3.parseObj = function(isPattern, refDestructuringErrors) {
    ...
    while (!this.eat(tt.braceR)) {
      ...
      if (!isPattern && this$1.options.ecmaVersion >= 8 && !isGenerator && !prop.computed && prop.key.type === "Identifier" && prop.key.name === "async" && this$1.type !== tt.parenL && !this$1.canInsertSemicolon()) {
        isAsync = true;
        this$1.parsePropertyName(prop, refDestructuringErrors);
      } else {
        isAsync = false;
  ...
  pp$3.parseYield = function(refDestructuringErrors) {
    var node = this.startNode();
    if (refDestructuringErrors)
      refDestructuringErrors.yield = this.start;
    this.next();
  ...
  pp$3.parseAwait = function(refDestructuringErrors) {
    var node = this.startNode();
    if (refDestructuringErrors)
      refDestructuringErrors.await = this.start;
    this.next();
    node.argument = this.parseMaybeUnary(refDestructuringErrors, true);
  ...
  Node$1.prototype.bind = function bind(scope) {
    ...
    this.eachChild(function(child) {
      return child.bind(this$1.scope || scope);
    });
  };
  Node$1.prototype.eachChild = function eachChild(callback) {
    var this$1 = this;
    for (var key of this.keys) {
      if (this$1.shorthand && key === 'key')
        continue;
  ...
  Node$1.prototype.initialise = function initialise(scope) {
    var this$1 = this;
    this.eachChild(function(child) {
      return child.initialise(this$1.scope || scope);
    });
  };
  ...
  var ArrayExpression = (function(Node) {
    ...
    if (Node)
      ArrayExpression.__proto__ = Node;
  ...
  var ArrowFunctionExpression = (function(Node) {
    ...
    if (Node)
      ArrowFunctionExpression.__proto__ = Node;
      ...
      if (this.body.type === 'BlockStatement') {
        ...
        for (var param of this.params) {
          for (var name of extractNames(param)) {
            this$1.scope.addDeclaration(name, null, null, true);
          }
        }
      }
  ...
  var AssignmentExpression = (function(Node) {
    ...
    if (Node)
      AssignmentExpression.__proto__ = Node;
    ...
    AssignmentExpression.prototype.bind = function bind(scope) {
      ...
      while (this.left.type === 'ParenthesizedExpression')
  ...
  var BinaryExpression = (function(Node) {
    ...
    if (Node)
      BinaryExpression.__proto__ = Node;
  ...
  var BlockStatement = (function(Statement) {
    ...
    if (Statement)
      BlockStatement.__proto__ = Statement;
  ...
  var ClassDeclaration = (function(Node) {
    ...
    if (Node)
      ClassDeclaration.__proto__ = Node;
    ...
    ClassDeclaration.prototype.activate = function activate() {
      ...
      this.activated = true;
      if (this.superClass)
        this.superClass.run(this.scope);
      this.body.run();
    };
  ...
  var ClassExpression = (function(Node) {
    ...
    if (Node)
      ClassExpression.__proto__ = Node;
  ...
  var ConditionalExpression = (function(Node) {
    ...
    if (Node)
      ConditionalExpression.__proto__ = Node;
  ...
  var EmptyStatement = (function(Statement) {
    ...
    if (Statement)
      EmptyStatement.__proto__ = Statement;
  ...
  var ExportAllDeclaration = (function(Node) {
    ...
    if (Node)
      ExportAllDeclaration.__proto__ = Node;
  ...
  var ExportDefaultDeclaration = (function(Node) {
    ...
    if (Node)
      ExportDefaultDeclaration.__proto__ = Node;
    ...
    ExportDefaultDeclaration.prototype.bind = function bind(scope) {
      ...
      if (name)
        this.original = scope.findDeclaration(name);
  ...
  var ExportNamedDeclaration = (function(Node) {
    ...
    if (Node)
      ExportNamedDeclaration.__proto__ = Node;
    ...
    ExportNamedDeclaration.prototype.initialise = function initialise(scope) {
      this.scope = scope;
      this.isExportDeclaration = true;
      var defaultExport = find(this.specifiers, function(specifier) {
  ...
  var ExpressionStatement = (function(Statement) {
    ...
    if (Statement)
      ExpressionStatement.__proto__ = Statement;
  ...
  var ForStatement = (function(Statement) {
    ...
    if (Statement)
      ForStatement.__proto__ = Statement;
  ...
  function assignToForLoopLeft(node, scope, value) {
    if (node.type === 'VariableDeclaration') {
      ...
      while (node.type === 'ParenthesizedExpression')
        node = node.expression;
      if (node.type === 'MemberExpression') {} else {
  ...
  var ForInStatement = (function(Statement) {
    ...
    if (Statement)
      ForInStatement.__proto__ = Statement;
  ...
  var ForOfStatement = (function(Statement) {
    ...
    if (Statement)
      ForOfStatement.__proto__ = Statement;
  ...
  var FunctionDeclaration = (function(Node) {
    ...
    if (Node)
      FunctionDeclaration.__proto__ = Node;
    ...
    FunctionDeclaration.prototype.bind = function bind(scope) {
      ...
      this.id.bind(scope);
      this.params.forEach(function(param) {
        return param.bind(this$1.body.scope);
      });
    ...
    FunctionDeclaration.prototype.initialise = function initialise(scope) {
      ...
      this.params.forEach(function(param) {
        return param.initialise(this$1.body.scope);
      });
  ...
  var IfStatement = (function(Statement) {
    ...
    if (Statement)
      IfStatement.__proto__ = Statement;
  ...
  var ImportDeclaration = (function(Node) {
    ...
    if (Node)
      ImportDeclaration.__proto__ = Node;
  ...
  var MemberExpression = (function(Node) {
    ...
    if (Node)
      MemberExpression.__proto__ = Node;
  ...
  var ObjectExpression = (function(Node) {
    ...
    if (Node)
      ObjectExpression.__proto__ = Node;
  ...
  var ParenthesizedExpression = (function(Node) {
    ...
    if (Node)
      ParenthesizedExpression.__proto__ = Node;
  ...
  var ReturnStatement = (function(Node) {
    ...
    if (Node)
      ReturnStatement.__proto__ = Node;
  ...
  var TemplateLiteral = (function(Node) {
    ...
    if (Node)
      TemplateLiteral.__proto__ = Node;
    ...
    ThisExpression.prototype.initialise = function initialise(scope) {
      ...
      if (lexicalBoundary.isModuleScope) {
        ...
        if (this.alias === 'undefined') {
          ...
          var detail = (relativeId(this.module.id)) + " (" + line + ":" + (column + 1) + ")";
  ...
  var ThrowStatement = (function(Node) {
    ...
    ThrowStatement.prototype.hasEffects = function hasEffects(scope) {
      return scope.findLexicalBoundary().isModuleScope;
    };
  ...
  var UnaryExpression = (function(Node) {
    ...
    if (Node)
      UnaryExpression.__proto__ = Node;
  ...
  var UpdateExpression = (function(Node) {
    ...
    if (Node)
      UpdateExpression.__proto__ = Node;
    ...
    UpdateExpression.prototype.bind = function bind(scope) {
      ...
      while (this.argument.type === 'ParenthesizedExpression')
        subject = subject.expression;
      this.subject = subject;
  ...
  DeclaratorProxy.prototype.activate = function activate() {
    ...
    this.duplicates.forEach(function(dupe) {
      return dupe.activate();
    });
  };
  ...
  var VariableDeclarator = (function(Node) {
    ...
    if (Node)
      VariableDeclarator.__proto__ = Node;
    ...
    VariableDeclarator.prototype.initialise = function initialise(scope) {
      ...
      var lexicalBoundary = scope.findLexicalBoundary();
      var init = this.init ? (this.id.type === 'Identifier' ? this.init : UNKNOWN) : null;
  ...
  var VariableDeclaration = (function(Node) {
    ...
    if (Node)
      VariableDeclaration.__proto__ = Node;
      ...
      var loop = function(i) {
        ...
        if (declarator.id.type === 'Identifier') {
          ...
          if (isExportedAndReassigned) {
            ...
            if (shouldSeparate)
              code.overwrite(c, declarator.start, ("" + prefix + (this$1.kind) + " "));
            c = declarator.end;
            empty = false;
          }
        } else {
  ...
  function enhance(ast, module, comments) {
    ...
    for (var node of ast.body) {
      ...
      if (comment && !newline.test(module.code.slice(node.end, comment.start))) {
        node.trailingCommentEnd = comment.end;
        comment = comments.shift();
      }
  ...
  var Module = function Module(ref) {
    ...
    this.comments = [];
    timeStart('ast');
    this.ast = ast || tryParse(code, this.comments, bundle.acornOptions, id);
  ...
  Module.prototype.render = function render(es, legacy) {
    ...
    if (this.namespace().needsNamespaceBlock) {
      magicString.append('\n\n' + this.namespace().renderBlock(es, legacy, '\t'));
    }
  ...
  Module.prototype.trace = function trace(name) {
    ...
    if (name in this.imports) {
      ...
      if (!declaration)
        throw new Error(("'" + (importDeclaration.name) + "' is not exported by " + (relativeId(otherModule.id)) + " (imported by " + (relativeId(this.id)) + "). For help fixing this error see https://github.com/rollup/rollup/wiki/Troubleshooting#name-is-not-exported-by-module"));
      return declaration;
    }
    return null;
  };
  ...
  function getExportBlock(entryModule, exportMode, mechanism) {
    ...
    return entryModule.getExports().map(function(name) {
      ...
      var rhs = declaration ? declaration.getName(false) : name;
      if (lhs === rhs)
        return null;
      return (lhs + " = " + rhs + ";");
    }).filter(Boolean).join('\n');
  ...
  function es(bundle, magicString, ref, options) {
    ...
    var importBlock = bundle.externalModules.map(function(module) {
      ...
      return specifiersList.map(function(specifiers) {
        return specifiers.length ? ("import " + (specifiers.join(', ')) + " from '" + (module.path) + "';") : ("import '" + (module.path) + "';");
      }).join('\n');
    }).join('\n');
    if (importBlock)
      intro += importBlock + '\n\n';
  ...
  function iife(bundle, magicString, ref, options) {
    ...
    if (options.outro)
      magicString.append(("\n" + (options.outro)));
    return magicString.indent(indentString).prepend(wrapperIntro).append(wrapperOutro);
  }
  ...
  function umd(bundle, magicString, ref, options) {
    ...
    if (options.outro)
      magicString.append(("\n" + (options.outro)));
    return magicString.trim().indent(indentString).append(wrapperOutro).prepend(wrapperIntro);
  }
  var finalisers = {
    amd: amd,
    cjs: cjs,
  ...
  function addJsExtensionIfNecessary(file) {
    try {
      ...
      if (~files.indexOf(name) && isFile(file))
        return file;
      if (~files.indexOf((name + ".js")) && isFile((file + ".js")))
        return (file + ".js");
    } catch (err) {}
    return null;
  }
  ...
  function collapseSourcemaps(file, map, modules, bundleSourcemapChain, onwarn) {
    ...
    if (file) {
      ...
      sources = sources.map(function(source) {
        return path.relative(directory, source);
      });
    }
    map.sources = sources;
  ...
  var Bundle = function Bundle(options) {
    ...
    this.getPath = typeof options.paths === 'function' ? (function(id) {
      return options.paths(id) || this$1.getPathRelativeToEntryDirname(id);
    }) : options.paths ? (function(id) {
      return options.paths.hasOwnProperty(id) ? options.paths[id] : this$1.getPathRelativeToEntryDirname(id);
    }) : function(id) {
      return this$1.getPathRelativeToEntryDirname(id);
    };
    this.scope = new BundleScope();
    ['module', 'exports', '_interopDefault'].forEach(function(name) {
      this$1.scope.findDeclaration(name);
    });
    ...
    if (typeof options.moduleContext === 'function') {
      this.getModuleContext = function(id) {
        return options.moduleContext(id) || this$1.context;
      };
      ...
      this.getModuleContext = function(id) {
        return moduleContext.get(id) || this$1.context;
      };
    } else {
      this.getModuleContext = function() {
        return this$1.context;
      };
    }
  ...
  Bundle.prototype.build = function build() {
    ...
    return this.resolveId(this.entry, undefined).then(function(id) {
      if (id == null)
        throw new Error(("Could not resolve entry (" + (this$1.entry) + ")"));
      this$1.entryId = id;
      ...
      if (this$1.treeshake) {
        ...
        while (!settled) {
          ...
          while (i--) {
            ...
            while (statement.parent && !/Function/.test(statement.parent.type))
  ...
  Bundle.prototype.deconflict = function deconflict() {
    var used = blank();
    keys(this.scope.declarations).forEach(function(name) {
      return used[name] = 1;
    });
  ...
  Bundle.prototype.fetchAllDependencies = function fetchAllDependencies(module) {
    ...
    return mapSequence(module.sources, function(source) {
      ...
      return (resolvedId ? Promise.resolve(resolvedId) : this$1.resolveId(source, module.id)).then(function(resolvedId) {
  ...
  Bundle.prototype.render = function render(options) {
    ...
    code = transformBundle(code, this.plugins, bundleSourcemapChain, options).replace(new RegExp(("\\/\\/#\\s+" + SOURCEMAPPING_URL$1 + "=.+\\n?"), 'g'), '');
    if (options.sourceMap) {
      timeStart('sourceMap');
      var file = options.sourceMapFile || options.dest;
      if (file)
        file = path.resolve(typeof process !== 'undefined' ? process.cwd() : '', file);
      if (this.hasLoaders || find(this.plugins, function(plugin) {
        return plugin.transform || plugin.transformBundle;
      })) {
  ...
  var VERSION = '0.36.4';
  var ALLOWED_KEYS = ['acorn', 'banner', 'cache', 'context', 'dest', 'entry', 'exports', 'external', 'footer', 'format', 'globals', 'indent', 'interop', 'intro', 'legacy', 'moduleContext', 'moduleId', 'moduleName', 'noConflict', 'onwarn', 'outro', 'paths', 'plugins', 'preferConst', 'sourceMap', 'sourceMapFile', 'targets', 'treeshake', 'useStrict'];
      ...
      function generate(options) {
        ...
        bundle.plugins.forEach(function(plugin) {
          if (plugin.ongenerate) {
            plugin.ongenerate(assign({bundle: result}, options), rendered);
          }
        });
        flushTime();
        return rendered;
      ...
      var result = {
        ...
        write: function(options) {
          ...
          return Promise.all(promises).then(function() {
            return mapSequence(bundle.plugins.filter(function(plugin) {
