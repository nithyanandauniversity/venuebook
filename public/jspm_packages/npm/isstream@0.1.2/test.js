...
var tape = require('tape'),
    ...
    util = require('util'),
    isStream = require('../isstream@0.1.2.json!systemjs-json'),
    isReadable = require('../isstream@0.1.2.json!systemjs-json').isReadable,
    isWritable = require('../isstream@0.1.2.json!systemjs-json').isWritable,
    isDuplex = require('../isstream@0.1.2.json!systemjs-json').isDuplex,
